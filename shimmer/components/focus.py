...
class FocusBox(MouseBox):
    ...
    def take_focus(self) -> bool:
        ...
        if not self._is_focused:
            self.logger.info(f"Taking focus on behalf of parent: {self.parent}")
...
class VisualAndKeyboardFocusBox(KeyboardFocusBox):
    ...
    def take_focus(self) -> bool:
        ...
        if took_focus:
            self.logger.debug(f"Taking visual focus.")
    ...
    def on_click(
        ...
        if took_focus:
            ...
            self.logger.debug(f"Resubmitted mouse_press_event for new focus stack.")
